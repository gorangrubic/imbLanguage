...
namespace imbNLP.Data.basic
{
    ...
    public static class basicLanguageTools
    {
        ...
        public static string testAndReport(this basicLanguage model, string testWord, basicLanguageCheck operation)
        {
            ...
            if (!model.checkHuspell(true)) return null;
        ...
        //public static T test<T>(this basicLanguage model, String testWord, basicLanguageCheck operation) where T:struct
        //{
        //    return test(model, testWord, operation) as T;
        //}
