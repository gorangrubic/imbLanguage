...
namespace imbNLP.Data.semanticLexicon.procedures
{
    ...
    public class lexiconConstructionSettings : aceSettingsStandaloneBase
    {
        ...
        public override string settings_filepath
        {
            get
            {
                return "configuration\\lexiconConstructionSettings.xml";
            }
        }

        private int _saveAllIterations = 25; // = new Int32();
                                               /// <summary>
        ...
        public int saveAllIterations
        {
            get
            {
                return _saveAllIterations;
            }
            set
            {
                _saveAllIterations = value;
                OnPropertyChanged("saveAllIterations");
            }
        }



        private int _fileTextSearchBlockSize = 500;
        /// <summary> </summary>
        public int fileTextSearchBlockSize
        {
            get
            {
                return _fileTextSearchBlockSize;
            }
            set
            {
                _fileTextSearchBlockSize = value;
                OnPropertyChanged("fileTextSearchBlockSize");
            }
        }


        private string _corpusProjectName = "corpus01"; // = new String();
        /// <summary>
        ...
        public string corpusProjectName
        {
            get
            {
                return _corpusProjectName;
            }
            set
            {
                _corpusProjectName = value;
                OnPropertyChanged("corpusProjectName");
            }
        }



        private string _corpusInput = "resources\\corpus\\sm_corpus_input.csv"; // = new String();
        /// <summary>
